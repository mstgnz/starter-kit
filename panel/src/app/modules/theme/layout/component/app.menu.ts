...
export class AppMenu {
    ...
    ngOnInit() {
        this.model = [
            {
                label: 'Home',
                items: [{ label: 'Dashboard', icon: 'pi pi-fw pi-home', routerLink: ['/theme/'] }]
            },
            {
                label: 'UI Components',
                items: [
                    ...
                    { label: 'Button', icon: 'pi pi-fw pi-mobile', class: 'rotated-icon', routerLink: ['/theme/uikit/button'] },
                    ...
                    { label: 'Menu', icon: 'pi pi-fw pi-bars', routerLink: ['/theme/uikit/menu'] },
                    ...
                    { label: 'Timeline', icon: 'pi pi-fw pi-calendar', routerLink: ['/theme/uikit/timeline'] },
            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        routerLink: ['/theme/pages/notfound']
                    },
                    {
                        label: 'Empty',
                ...
                items: [
                    {
                        ...
                        routerLink: ['/theme/documentation']
                    },
                    {
                        label: 'View Source',
